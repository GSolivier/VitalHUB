...
export default function Login({navigation}) {
  return (
    <AuthContainer>
      ...
      <TitleMedium 
      size={'14px'} 
      color={AppColors.grayV2}>{translate(AppLocalizations.dontHaveAccount)} <LinkButton onTap={() => {navigation.navigate('CreateAccount')}} color={AppColors.darkBlueV6} text={translate(AppLocalizations.createAccount)} /></TitleMedium>
